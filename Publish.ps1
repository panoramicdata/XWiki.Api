...
# Progress is reported on the information stream rather than the host, so it can be captured or
# redirected. 'Continue' keeps it on screen without every caller passing -InformationAction.
